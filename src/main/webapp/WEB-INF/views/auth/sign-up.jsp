    ...
    <body class="bg-gray-50">
        ...
        <main class="flex items-center justify-center min-h-screen pt-16">
            <div class="bg-white w-full max-w-md p-8 shadow-md rounded">
                ...
                <form action="${pageContext.request.contextPath}/auth/register" method="post" class="space-y-5">
                    <div>
                ...
                <p class="text-center text-sm text-gray-600 mt-6">
                    ...
                    <a class="text-indigo-700 font-medium hover:underline" href="${pageContext.request.contextPath}/login">Login</a>
                </p>
            </div>
        </main>
    </body>
