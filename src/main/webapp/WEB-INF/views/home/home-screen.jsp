...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="reviews" id="reviews">
            <h1 class="heading">Opinião dos <span>Clientes</span></h1>
        ...
        <footer class="footer">
            <div class="box-container">
                <div class="box">
                    ...
                    <a href=""><i class="fas fa-map-marker-alt"></i>Florianópils</a>
                ...
                <div class="box">
                    ...
                    <a href="#vehicles" class=""><i class="fas fa-arrow-right"></i>Veículos</a>
                    <a href="#services" class=""><i class="fas fa-arrow-right"></i>Serviços</a>
                    <a href="#featured" class=""><i class="fas fa-arrow-right"></i>Novidades</a>
                    <a href="#reviews" class=""><i class="fas fa-arrow-right"></i>Avaliações</a>
